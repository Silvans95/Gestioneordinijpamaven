...
//  #############################################################################################################
	...
	@Override
	public void scollegaCategoria(Articolo articoloInstance, Categoria categoriaInstance) throws Exception {
		EntityManager entityManager = EntityManagerUtil.getEntityManager();
		...
		try {
			...
			articoloInstance.removeFromCategoria(categoriaInstance);
...
//	#################################### METODI NON CRUDE ##################################################################
	@Override
	public Long calcolaSommaPrezziCategoria(Categoria categoriaInstance) throws Exception {
		EntityManager entityManager = EntityManagerUtil.getEntityManager();
		...
		try {
			...
			return articoloDAO.findSommaArticoloCategoria(categoriaInstance);
